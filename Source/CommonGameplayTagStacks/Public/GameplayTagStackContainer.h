...
struct COMMONGAMEPLAYTAGSTACKS_API FGameplayTagStack : public FFastArraySerializerItem
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMMONGAMEPLAYTAGSTACKS_API FGameplayTagStackContainer : public FFastArraySerializer
{
	GENERATED_BODY()
